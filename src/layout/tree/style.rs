...
impl Edges {
    ...
    pub fn new(left: f32, top: f32, right: f32, bottom: f32) -> Result<Self, DocumentError> {
    ...
    pub fn all(value: f32) -> Result<Self, DocumentError> {
...
impl BorderStyle {
    pub fn new(color: [f32; 4], width: f32) -> Result<Self, DocumentError> {
...
#[derive(Clone, Copy, Debug, PartialEq)]
pub struct InlineAtomStyle {
    pub margin: Edges,
    pub padding: Edges,
    pub baseline: AtomBaseline,
    pub background: Option<[f32; 4]>,
    pub border: Option<BorderStyle>,
}
